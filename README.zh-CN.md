...
项目代码使用 [MIT License](LICENSE)。内置 xterm.js 和 DejaVu 字体遵循各自协议，详见 [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md)。MIT 授权代码本身；项目名称和标识的使用边界另见 [TRADEMARKS.md](TRADEMARKS.md)。
